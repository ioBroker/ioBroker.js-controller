...
editLink: https://github.com/ioBroker/ioBroker.megad/edit/master//README.md
title: Mega-D Adapter
hash: ukQz4Z7heTE/fNMzOhsx6fPwXwoF/mzDxc9CDSpp0oc=
adapter: true
license: MIT
authors: bluefox <dogafox@gmail.com>
description: Lets control the MegaD-328 over ethernet/internet (http://www.ab-log.ru/smart-house/ethernet/megad-328)
...
version: 1.2.1
BADGE-安装数量: http://iobroker.live/badges/megad-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.megad.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.megad.svg
BADGE-测试: https://travis-ci.org/ioBroker/ioBroker.megad.svg?branch=master
BADGE-NPM: https://nodei.co/npm/iobroker.megad.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.megad/../../../en/adapterref/iobroker.megad/admin/megad.png)ioBrokerMegaD-328适配器=================


让我们通过以太网控制[MegaD-328](http://www.ab-log.ru/smart-house/ethernet/megad-328)。
