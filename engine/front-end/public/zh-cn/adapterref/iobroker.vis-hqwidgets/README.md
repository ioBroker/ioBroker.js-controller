...
editLink: https://github.com/ioBroker/ioBroker.vis-hqwidgets/edit/master//README.md
title: hqwidgets style Widgets
hash: jPQegu6pF6O2hzwFNfhetVOfbBWWxDaDYcjjC49bstY=
adapter: true
license: MIT
authors: bluefox <dogafox@gmail.com>
description: High quality Widgets for ioBroker.vis
keywords: hqwidgets, vis, GUI, graphical, scada
readme: https://github.com/ioBroker/ioBroker.vis-hqwidgets/blob/master/README.md
mode: once
materialize: false
compact: false
published: 2015-07-19T16:00:19.063Z
version: 1.1.2
BADGE-安装数量: http://iobroker.live/badges/vis-hqwidgets-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.vis-hqwidgets.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.vis-hqwidgets.svg
BADGE-NPM: https://nodei.co/npm/iobroker.vis-hqwidgets.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.vis-hqwidgets/../../../en/adapterref/iobroker.vis-hqwidgets/admin/hqwidgets.png)ioBroker.vis-hqWidgets ============


hqWidgets  -  ioBroker.vis的高质量小部件![例](zh-cn/adapterref/iobroker.vis-hqwidgets/../../../en/adapterref/iobroker.vis-hqwidgets/img/widgets.png)
