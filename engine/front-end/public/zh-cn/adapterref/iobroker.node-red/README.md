...
editLink: https://github.com/ioBroker/ioBroker.node-red/edit/master//README.md
title: node-red
hash: 6nDiKCG5sDpMw4QOrCbKZ58n1xKuED6dvLUU6GqCqvM=
adapter: true
license: Apache-2.0
authors: bluefox <dogafox@gmail.com>
description: 此适配器将node-red作为服务, 不需要额外安装node-red实例.
keywords: node-red, logic, script
readme: https://github.com/ioBroker/ioBroker.node-red/blob/master/README.md
mode: daemon
materialize: true
compact: false
published: 2015-01-02T21:28:03.378Z
version: 1.7.1
BADGE-安装数量: http://iobroker.live/badges/node-red-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.node-red.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.node-red.svg
BADGE-测试: https://travis-ci.org/ioBroker/ioBroker.node-red.svg?branch=master
BADGE-NPM: https://nodei.co/npm/iobroker.node-red.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.node-red/../../../en/adapterref/iobroker.node-red/admin/node-red.png)
