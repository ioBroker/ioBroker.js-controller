...
editLink: https://github.com/ioBroker/ioBroker.vis-jqui-mfd/edit/master//README.md
title: jQuery-UI style Widgets
hash: 1WvuvF+Xi1cX0QxLFR9e9gZEo5wq5LRDxE6dMJJet0s=
adapter: true
license: MIT
authors: hobbyquaker <hq@ccu.io>, bluefox <dogafox@gmail.com>
description: jQuery-UI Widgets for ioBroker.vis with OpenAutomationProject icons
keywords: jqui-mfd, vis, GUI, IoT, graphical, scada
readme: https://github.com/ioBroker/ioBroker.vis-jqui-mfd/blob/master/README.md
mode: once
materialize: false
compact: false
published: 2015-09-30T20:11:35.214Z
version: 1.0.12
BADGE-安装数量: http://iobroker.live/badges/vis-jqui-mfd-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.vis-jqui-mfd.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.vis-jqui-mfd.svg
BADGE-NPM: https://nodei.co/npm/iobroker.vis-jqui-mfd.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.vis-jqui-mfd/../../../en/adapterref/iobroker.vis-jqui-mfd/admin/jqui-mfd.png)
...
![截图](zh-cn/adapterref/iobroker.vis-jqui-mfd/../../../en/adapterref/iobroker.vis-jqui-mfd/img/Demo2.png)
