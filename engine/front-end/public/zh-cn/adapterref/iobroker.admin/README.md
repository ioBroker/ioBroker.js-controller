...
adapter: true
editLink: https://github.com/ioBroker/ioBroker.admin/edit/master//README.md
license: MIT
...
![img_002](zh-cn/adapterref/iobroker.admin/img/admin_img_002.png)
...
可以安装或删除适配器。使用更新按钮
![img_005](zh-cn/adapterref/iobroker.admin/img/admin_img_005.png)
如果新版本的适配器可用，我们可以在左上角看到。
![img_001](zh-cn/adapterref/iobroker.admin/img/admin_img_001.jpg)
...
![img_003](zh-cn/adapterref/iobroker.admin/img/admin_img_003.png)

**对象：** 管理对象（例如连接硬件的设置/变量/程序）

![img_004](zh-cn/adapterref/iobroker.admin/img/admin_img_004.png)
