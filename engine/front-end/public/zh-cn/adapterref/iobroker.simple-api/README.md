...
editLink: https://github.com/ioBroker/ioBroker.simple-api/edit/master//README.md
...
description: This adapter allows to read and write ioBroker objects and state with web RESTful API
keywords: web, simpleAPI, RESTful, communication
readme: https://github.com/ioBroker/ioBroker.simple-api/blob/master/README.md
mode: daemon
materialize: false
compact: true
published: 2015-02-06T06:54:32.754Z
version: 2.0.2
BADGE-安装数量: http://iobroker.live/badges/simple-api-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.simple-api.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.simple-api.svg
BADGE-测试: https://travis-ci.org/ioBroker/ioBroker.simple-api.svg?branch=master
BADGE-NPM: https://nodei.co/npm/iobroker.simple-api.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.simple-api/../../../en/adapterref/iobroker.simple-api/admin/simple-api.png)ioBrokersimple-api适配器=================
