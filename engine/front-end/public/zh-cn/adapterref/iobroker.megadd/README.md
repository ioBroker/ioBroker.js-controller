...
editLink: https://github.com/ausHaus/ioBroker.megadd/edit/master//README.md
title: MegaD-2561 Adapter
hash: IROhGk54YUJ2psVEN0iDb9Nnp/gDHwww6G0WkyWEeKs=
adapter: true
license: MIT
authors: ausHaus <teshaus@gmail.com>
description: Lets control the MegaD-2561 over ethernet/internet (http://www.ab-log.ru/smart-house/ethernet/megad-2561)
...
version: 0.2.0
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.megadd.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.megadd.svg
BADGE-NPM: https://nodei.co/npm/iobroker.megadd.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.megadd/../../../en/adapterref/iobroker.megadd/admin/megad.png)ioBrokerMegaD-2561适配器=================
