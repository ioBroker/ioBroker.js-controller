...
editLink: https://github.com/ioBroker/ioBroker.web/edit/master//README.md
title: Web服务器
hash: 04MJnPlVJTWOaRDcaQCT90y8oQhXwCNTIZEekXjHNNA=
adapter: true
license: MIT
authors: bluefox <dogafox@gmail.com>
description: 为其他适配器服务的web服务器
keywords: web, server, www, express
readme: https://github.com/ioBroker/ioBroker.web/blob/master/README.md
mode: daemon
materialize: true
compact: true
published: 2015-01-02T20:45:26.654Z
version: 2.4.1
BADGE-安装数量: http://iobroker.live/badges/web-stable.svg
BADGE-NPM版本: http://img.shields.io/npm/v/iobroker.web.svg
BADGE-下载: https://img.shields.io/npm/dm/iobroker.web.svg
BADGE-测试: https://travis-ci.org/ioBroker/ioBroker.web.svg?branch=master
BADGE-NPM: https://nodei.co/npm/iobroker.web.png?downloads=true
---
![商标](zh-cn/adapterref/iobroker.web/../../../en/adapterref/iobroker.web/admin/web.png)
