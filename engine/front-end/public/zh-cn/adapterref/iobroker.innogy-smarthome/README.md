...
editLink: https://github.com/PArns/ioBroker.innogy-smarthome/edit/master//README.md
...
keywords: innogy-smarthome
readme: https://github.com/PArns/ioBroker.innogy-smarthome/blob/master/README.md
mode: daemon
materialize: false
compact: false
published: 2017-01-07T12:19:30.574Z
version: 0.2.11
BADGE-建立: https://travis-ci.org/PArns/ioBroker.innogy-smarthome.svg?branch=master
---
![商标](zh-cn/adapterref/iobroker.innogy-smarthome/../../../en/adapterref/iobroker.innogy-smarthome/admin/innogy-smarthome.png)


＃ioBroker.Innogy-SmartHome
此适配器用于将Innogy智能家居设备连接到ioBroker。您可以阅读有关Innogy[这里](https://www.innogy.com)的更多信息。
