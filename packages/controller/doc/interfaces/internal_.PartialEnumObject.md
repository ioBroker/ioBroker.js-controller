...
- [`Partial`](../modules/internal_.md#partial)<[`Omit`](../modules/internal_.md#omit)<[`EnumObject`](internal_.EnumObject.md), ``"common"``\>\>
...
• `Optional` **common**: [`Partial`](../modules/internal_.md#partial)<[`EnumCommon`](internal_.EnumCommon.md)\>

#### Defined in

node_modules/@types/iobroker/objects.d.ts:585
...
node_modules/@types/iobroker/objects.d.ts:581
