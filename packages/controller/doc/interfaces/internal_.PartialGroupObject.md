...
- [`Partial`](../modules/internal_.md#partial)<[`Omit`](../modules/internal_.md#omit)<[`GroupObject`](internal_.GroupObject.md), ``"common"``\>\>
...
• `Optional` **common**: [`Partial`](../modules/internal_.md#partial)<[`GroupCommon`](internal_.GroupCommon.md)\>

#### Defined in

node_modules/@types/iobroker/objects.d.ts:639
...
node_modules/@types/iobroker/objects.d.ts:635
