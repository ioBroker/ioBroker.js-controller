...
- [`Partial`](../modules/internal_.md#partial)<[`Omit`](../modules/internal_.md#omit)<[`InstanceObject`](internal_.InstanceObject.md), ``"common"``\>\>
...
• `Optional` **common**: [`Partial`](../modules/internal_.md#partial)<[`InstanceCommon`](internal_.InstanceCommon.md)\>

#### Defined in

node_modules/@types/iobroker/objects.d.ts:601
