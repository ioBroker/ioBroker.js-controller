...
Basic settings if you intend to use the server/broker is shown in the picture: [![](http://www.iobroker.net/wp-content/uploads//4-282x300.png)](http://www.iobroker.net/wp-content/uploads//4.png)
