...
class ObjectsInMemoryFileDB extends InMemoryFileDB {
    ...
    syncFileDirectory(limitId, callback) {
        ...
        this.getObjectView('system', 'meta', null,(err, res) => {
            ...
            res.rows.forEach(obj => {
                if (!obj.value || !obj.value.common || !obj.value.common.type) return;
                if (limitId && obj.id !== limitId) return;
            ...
            try {
                ...
                baseDirs.forEach(dir => {
                    ...
                    files.forEach(file => {
                        ...
                        if (localFile === '_data.json') return;
    ...
    _writeFile(id, name, data, options, callback) {
        try {
            try {
                ...
                this.log.error(this.namespace + ' Check the permissions! Or run installation fixer!');
    ...
    _extendObject(id, obj, options, callback) {
        ...
        typeof callback === 'function' && setImmediate((obj) => callback(null, obj, id), {id: id, value: this.dataset[id]});
