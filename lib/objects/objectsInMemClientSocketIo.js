...
class ObjectsInMemClient {
    constructor(settings) {
        ...
        this.client.on('connect', () => {
            ...
            this.log.debug(settings.namespace + ' Objects connected to socket.io: ' + settings.connection.host);
        ...
        this.connectionTimeout = setTimeout(() => {
            typeof this.settings.connectTimeout === 'function' && this.settings.connectTimeout('Connection timeout');
            this.connectionTimeout = null;
        }, 5000);
    }
