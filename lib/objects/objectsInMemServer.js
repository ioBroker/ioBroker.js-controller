...
function ObjectsInMemServer(settings) {
    ...
    this.writeFile = function (id, name, data, options, callback) {
        ...
        try {
            ...
            return checkFileRights(id, name, options, 0x2/*write*/, (err, options) => {
                if (err) {
                    if (typeof callback === 'function') {
                        callback(err);
                    }
    ...
    this.enableFileCache = function (enabled, options, callback) {
        ...
        checkObjectRights(null, options, 0x2/*write*/, (err, options) => {
            if (err) {
                if (typeof callback === 'function') callback(err);
            } else {
    ...
    this.getObject = function (id, options, callback) {
        ...
        if (typeof callback === 'function') {
            ...
            checkObjectRights(id, options, 0x4/*read*/, (err, options) => {
                if (err) {
                    if (typeof callback === 'function') callback(err);
                } else {
    ...
    this.getObjects = function (keys, options, callback, dontModify) {
        ...
        if (!callback) {
            return new Promise((resolve, reject) => {
                this.getObjects(keys, options, (err, obj) => {
                    if (err) {
                        reject(err);
                    } else {
                        resolve(obj);
        ...
        if (defaultNewAcl && !obj.acl) {
            ...
            if (options.owner) {
                ...
                if (!options.ownerGroup) {
                    ...
                    that.getUserGroup(options.owner, function (user, groups /* , permissions */) {
                        if (!groups || !groups[0]) {
    ...
    this.setObject = function (id, obj, options, callback) {
        ...
        if (!callback) {
            return new Promise((resolve, reject) => {
                this.setObject(id, obj, options, (err, obj) => {
                    if (err) {
                        reject(err);
                    } else {
                        resolve(obj);
        ...
        checkObjectRights(id, options, 0x2/*write*/, (err, options) => {
            if (err) {
                if (typeof callback === 'function') {
                    callback(err);
                }
    ...
    this.delObject = function (id, options, callback) {
        ...
        if (options && options.acl) options.acl = null;
        checkObjectRights(id, options, 'delete', (err, options) => {
            if (err) {
                if (typeof callback === 'function') callback(err);
            } else {
