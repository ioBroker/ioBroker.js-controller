...
function ObjectsInMemServer(settings) {
    ...
    let objectsDir  = dataDir + 'files/';
    //let historyName = dataDir + 'history/';

    //let regHistory = new RegExp('^history.');
    ...
    this.setObject = function (id, obj, options, callback) {
        ...
        tools.checkNonEditable(objects[id], obj);
    ...
    this.extendObject = function (id, obj, options, callback) {
        ...
        if (oldObj) {
            tools.checkNonEditable(oldObj, objects[id]);
        }
