...
function ObjectsInMem(settings) {
    ...
    this.setDefaultAcl = function (acl, options, callback) {
        if (!options || !options.checked) {
            ...
            */
            this.getObject('system.config', function (err, obj) {
                if (obj && obj.common) obj.common.defaultNewAcl = JSON.parse(JSON.stringify(defaultNewAcl));
                that.setObject('system.config', function (/* err */) {
                    callback(null, count);
                });
            });
        }
    ...
    this.getObject = function (id, options, callback) {
        ...
        if (typeof callback === 'function') {
            states.getConfig(id, function (err, body) {
                ...
                // Todo Error handling
                callback(err, JSON.parse(JSON.stringify(body)));
            });
        }
    };
