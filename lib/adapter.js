...
function Adapter(options) {
     ...
     * @param {function(number):any} callback return result
     ...
     * @param {function(boolean):any} callback return result
     *        <pre><code>
     *            function (result) {
     ...
     * @param {string} pw password as text
     * @param {object} [options] optional user context
     * @param {function(Error=):any} [callback] return result
     *        <pre><code>
     *            function (err) {
     ...
     *        </code></pre>
     * @param {object} [options] optional user context
     * @param {function(object):any} [callback] return result
     *        <pre><code>
     *            function (acl) {
     ...
     * @param {function(Error=, object=, object=):any} callback return result
     *        <pre><code>
     ...
     * @param {function(Error=, string=):any} [callback] - optional callback
    ...
    const initObjects = cb => {
         ...
         * @param {object} [options] optional user context
         * @param {function(Error=, object=):any} [callback] return result
         *        <pre><code>
         *            function (err, obj) {
         *              // obj is {id: id}
         ...
         * @param {object} params
         * @param {object} options
         * @param {function(Error=, object=):any} callback
         *      <pre><code>
         *          function (err, res) {
         *              if (res && res.rows) {
         ...
         * @param {object} [options] optional user context
         * @param {function(Error=, object=, string=):any} callback return result
         *        <pre><code>
         ...
         * @param {object} options optional user context
         * @param {function(Error=, string=, string=):any} callback return result
         *        <pre><code>
         ...
         * @param {object} [options] optional user context
         * @param {function(Error):any} [callback] optional returns result
         *        <pre><code>
         *            function (err) {
            ...
            adapterObjects.getObjectView('system', 'enum', {startkey: enumName, endkey: enumName + '\u9999'}, options,  async (err, res) => {
                ...
                for (const row of res.rows) {
                    try {
                        ...
                        return tools.maybeCallbackWithError(e);
                    }
         ...
         * @param {object} options optional user context
         * @param {function(Error=, string|Buffer=):any} callback return result
         *        <pre><code>
         *            function (err, data) {
    ...
    const initStates = cb => {
         ...
         * @param {object} [options] optional user context
         * @param {function(Error=, string=):any} [callback] optional return error and id
         *        <pre><code>
         *            function (err, id) {
         ...
         * @param {boolean} [ack] optional is command(false) or status(true)
         * @param {object} [options] optional user context
         * @param {function(Error=, string=, boolean=):any} [callback] optional return error, id and notChanged
         *        <pre><code>
         ...
         * @param {function(Error=, object=, number=, string=):any} callback return result
         *        <pre><code>
        ...
        this.getHistory = (id, options, callback) => {
            ...
            this.sendTo(options.instance || 'history.0', 'getHistory', {id: id, options: options}, res => {
                return tools.maybeCallbackWithError(res.error, res.result, res.step, res.sessionId);
            });
        };
        /**
         ...
         * @param {function(Error=):any} [callback] return result function (err) {}
         */
        this.delForeignState = (id, options, callback) => {
            if (typeof options === 'function') {
                callback = options;
         ...
         * @param {object} options optional argument to describe the user context
         * @param {function(Error=, object=):any} callback return result function (err, states) {}, where states is an object like {"ID1": {"val": 1, "ack": true}, "ID2": {"val": 2, "ack": false}, ...}
         */
