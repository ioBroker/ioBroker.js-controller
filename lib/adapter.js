    ...
    const initStates = cb => {
        ...
        function validateSetStateObjectArgument(obj) {
            ...
            */
            ...
            const forbiddenProperties = Object.keys(obj).filter(k => !optionalProperties.includes(k));
            ...
            const missingProperties = Object.keys(optionalProperties).filter(k => !(k in obj));
