...
// remove "lib"
        this.adapterDir.pop();
        if (this.adapterDir.pop() == 'iobroker.js-controller' && this.adapterDir.pop() == 'node_modules') {
            // js-controller is installed as npm
            this.adapterDir = this.adapterDir.join('/');
            if (fs.existsSync(this.adapterDir + '/iobroker.' + options.name)) {
                this.adapterDir += '/iobroker.' + options.name;
            } else if (fs.existsSync(this.adapterDir + '/iobroker.js-controller/node_modules/iobroker.' + options.name)) {
                this.adapterDir += '/iobroker.js-controller/node_modules/iobroker.' + options.name;
            } else if (fs.existsSync(this.adapterDir + '/iobroker.js-controller/adapter/' + options.name)) {
                this.adapterDir += '/iobroker.js-controller/adapter/' + options.name;
            } else {
