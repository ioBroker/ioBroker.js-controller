...
function Adapter(options) {
        ...
        this.getForeignObject(user, options, (err, obj) => {
            if (err || !obj || !obj.common || (!obj.common.enabled && user !== SYSTEM_ADMIN_USER)) {
                ...
                password(pw).check(obj.common.password, (err, res) => {
                    return tools.maybeCallback(callback, res);
                });
            }
        });
    };
     ...
     */
    this.setTimeout = function (cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
        timerId = (timerId + 1) % 0xFFFFFFFF;

        const _cb = (function (id, _cb) {
            return function (_a1, _a2, _a3, _a4, _a5, _a6, _a7, _a8, _a9) {
                delete timers[id];
                if (_a9 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4, _a5, _a6, _a7, _a8, _a9);
                } else if (_a8 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4, _a5, _a6, _a7, _a8);
                } else if (_a7 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4, _a5, _a6, _a7);
                } else if (_a6 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4, _a5, _a6);
                } else if (_a5 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4, _a5);
                } else if (_a4 !== undefined) {
                    _cb(_a1, _a2, _a3, _a4);
                } else if (_a3 !== undefined) {
                    _cb(_a1, _a2, _a3);
                } else if (_a2 !== undefined) {
                    _cb(_a1, _a2);
                } else if (_a1 !== undefined) {
                    _cb(_a1);
                } else {
                    _cb();
                }
        ...
        if (a9 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8, a9);
        } else if (a8 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8);
        } else if (a7 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4, a5, a6, a7);
        } else if (a6 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4, a5, a6);
        } else if (a5 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4, a5);
        } else if (a4 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3, a4);
        } else if (a3 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2, a3);
        } else if (a2 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1, a2);
        } else if (a1 !== undefined) {
            timers[timerId] = setTimeout.call(null, _cb, timeout, a1);
        } else {
            timers[timerId] = setTimeout.call(null, _cb, timeout);
        }
     ...
     */
    this.setInterval = function (cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
        timerId = (timerId + 1) % 0xFFFFFFFF;
        if (a9 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8, a9);
        } else if (a8 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4, a5, a6, a7, a8);
        } else if (a7 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4, a5, a6, a7);
        } else if (a6 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4, a5, a6);
        } else if (a5 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4, a5);
        } else if (a4 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3, a4);
        } else if (a3 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2, a3);
        } else if (a2 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1, a2);
        } else if (a1 !== undefined) {
            intervals[timerId] = setInterval.call(null, cb, timeout, a1);
        } else {
            intervals[timerId] = setInterval.call(null, cb, timeout);
        }
    ...
    const initObjects = cb => {
                                ...
                                if (newSourceId !== sourceId) {
                                    this._removeAliasSubscribe(sourceId, targetAlias, async () => {
                                        try {
                                            ...
                                            logger.error(`${this.namespaceLog} Could not add alias subscription: ${e}`);
                                        }
                                    });
                                } else {
                                    // update attributes
        ...
        const setObjectWithDefaultValue = async (id, obj, options, callback) => {
            ...
            if (!adapterObjects) { // if objects is no longer existing, we do not need to unsubscribe
                return tools.maybeCallbackWithError(callback, 'Objects database not connected');
            }
        ...
        this.getAdapterObjects = callback => {
            ...
            if (!adapterObjects) { // if objects is no longer existing, we do not need to unsubscribe
                return tools.maybeCallback(callback, objects);
            }
                ...
                adapterObjects.getObject(id, options, (err, obj) => {
                    ...
                    adapterObjects.getObjectView('system', 'state', selector, options, (err, res) => {
                        ...
                        adapterObjects.getObjectView('system', 'channel', selector, options, (err, res) => {
                            res && res.rows && res.rows.forEach(item => !tasks.find(task => task.id === item.id) && tasks.push({id: item.id, state: false}));
        ...
        this.setObjectNotExists = async (id, obj, options, callback) => {
            ...
            try {
                ...
                return tools.maybeCallbackWithError(callback, `Could not check object existence of ${id}: ${e}`);
            }
        ...
        if (id.startsWith(ALIAS_STARTS_WITH)) {
            adapterObjects.getObject(id, (err, obj) => {
                if (obj && obj.common && obj.common.alias && obj.common.alias.id) {
                    ...
                    return tools.maybeCallbackWithError(callback, err || `Alias ${id} has no target`);
                }
            });
        } else {
                ...
                if (err) {
                    ...
                    if (differ) {
                        if (this.performStrictObjectChecks) {
                            ...
                            try {
                                const objExisting = await adapterObjects.objectExists(id);
                                if (!objExisting) {
                                    logger.warn(`${this.namespaceLog} State "${id}" has no existing object, this might lead to an error in future versions`);
                                }
                            } catch (e) {
                                logger.warn(`${this.namespaceLog} Could not check object existence of state ${id}: ${e}`);
                            }
                        }
                        this.outputCount++;
    ...
    const initStates = cb => {
        ...
        this.sendTo = (instanceName, command, message, callback) => {
            ...
            if (!adapterStates) { // if states is no longer existing, we do not need to unsubscribe
                return tools.maybeCallbackWithError(callback, 'States database not connected');
            }
                ...
                checkStates(id, options, 'getState', (err, obj) => {
                    if (err) {
                        ...
                        if (id.startsWith(ALIAS_STARTS_WITH)) {
                            ...
                            if (this.oStates && this.oStates[id]) {
                                return tools.maybeCallbackWithError(callback, this.oStates[id]);
                            } else {
                                adapterStates.getState(id, callback);
                            }
                        }
                        ...
                        adapterObjects.getObject(sourceId, options, (err, sourceObj) => {
                            if (sourceObj && sourceObj.common) {
                                if (!this.aliases[sourceObj._id]) {
                                    logger.error(`Something went wrong: sourceId=${sourceId}, sourceObj=${JSON.stringify(sourceObj)}`);
                                } else {
            ...
            autoSubscribeOn(async () => {
                ...
                if (Array.isArray(pattern)) {
                    ...
                    adapterObjects.getObject(pattern, options, (err, aliasObj) => {
                        ...
                        if (aliasObj) {
                            try {
                                const resultPromise = this._addAliasSubscribe(aliasObj, pattern, callback);
                                if (resultPromise instanceof Promise) {
                                    resultPromise.catch(e =>
                                        logger.warn(`${this.namespaceLog} cannot subscribe on alias "${pattern}": ${e}`));
                                }
                            } catch (e) {
                                logger.warn(`${this.namespaceLog} cannot subscribe on alias "${pattern}": ${e}`)
                            }
        ...
        this.getMessage = callback => {
            ...
            return tools.maybeCallbackWithError(callback, null, null, null);
        };
    };
