...
function Adapter(options) {
    ...
    function initCouch(cb) {
        ...
        that.extendObject = function extendObject(id, obj, callback) {
            ...
            if (obj && (obj.children || (obj.common && (obj.common.listRepo || obj.common.members || obj.common.certificates)))) {
                // Read whole object
                that.objects.getObject(id, function (err, oldObj) {
                    if (obj.children && oldObj.children) {
                        oldObj.children = [];
                    }
                    if (obj.common.listRepo && oldObj.common && oldObj.common.listRepo) {
                        oldObj.common.listRepo = [];
                    }
