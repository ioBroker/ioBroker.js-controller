...
const EXIT_CODES = {
    ...
    START_IMMEDIATELY_AFTER_STOP: -100,
...
function Adapter(options) {
    ...
    that.terminate = (reason, exitCode) => {
        // This function must be defined very first, becasue in the next lines will be yet used.
    ...
    if (options.systemConfig) this.systemConfig = config;
