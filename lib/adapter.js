        ...
        that.setObject = function setObject(id, obj, callback) {
            ...
            if (obj && obj.hasOwnProperty("type")) {
                ...
                if (!obj.hasOwnProperty("common")) {
                    ...
                    logger.warn(that.namespace + ' Object "' + id + '" with type state has no property common!');
                    ...
                    if (!obj.common.hasOwnProperty("members")) {
                        logger.warn(that.namespace + ' Channel "' + id + '" has no property common.members!');
                    }
                }
                
                if (!obj.common.hasOwnProperty("name")) {
                    obj.common.name = id;
                    logger.warn(that.namespace + ' Object "' + id + '" has no property common.name. Using id as a name.');
                }
            } else {
                // TODO: What to do with that
                if (!obj) logger.warn(that.namespace + ' Object "' + id + '" is NULL!');
                else      logger.warn(that.namespace + ' Object "' + id + '" has no property type!');
            }
