...
function Adapter(options) {
    ...
    function initCouch(callback) {
        ...
        that.isMember = function isMember(idObj, idEnum) {

        };

        that.isMemberRecursive = function isMember(idObj, idEnum) {

        };

        that.getObjectEnums = function getObjectEnums(idObj, idEnum) {

        };

        that.getObjectEnumsRecursive = function getObjectEnums(idObj, idEnum) {
