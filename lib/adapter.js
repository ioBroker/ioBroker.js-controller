                    ...
                    if (state.val !== null) {
                        ...
                        if (!(obj.common.type === 'mixed' && typeof state.val !== 'object' ||
                            ...
                            if (['object', 'json', 'file', 'array'].includes(obj.common.type)) {
                                logger.warn(`${this.namespaceLog} State value to set for "${id}" has to be type "string" but received type "${typeof state.val}"`);
                            } else {
                                logger.warn(`${this.namespaceLog} State value to set for "${id}" has to be ${obj.common.type === 'mixed' ? `one of type "string", "number", "boolean"` : `type "${obj.common.type}"`} but received type "${typeof state.val}" `);
                            }
                        }
                        ...
                        if (typeof state.val === 'number') {
                            ...
                            if (obj.common.min !== undefined && state.val < obj.common.min) {
                                logger.warn(`${this.namespaceLog} State value to set for "${id}" has value "${state.val}" less than min "${obj.common.max}"`);
                            }
                        }
                    }
                } else {
