...
function Adapter(options) {
    ...
    const initObjects = (cb) => {
        ...
        this.setForeignObject = (id, obj, options, callback) => {
            ...
            if (obj && obj.common && obj.common.alias && obj.common.alias.id && obj.common.alias.id.startsWith('system.')) {
                return callback && callback('system.* states cannot be used as target for aliases');
            }
