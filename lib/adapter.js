...
var defaultObjs =   require(__dirname + '/defaultObjs.js');
...
function Adapter(options) {
    ...
    function initCouch(callback) {
        ...
        that.setObject = function setObject(id, obj, callback) {
            ...
            if (obj && obj.hasOwnProperty("type") && obj.type == "state" && obj.hasOwnProperty("common") && obj.common.hasOwnProperty("role")) {
                if (defaultObjs[obj.common.role]) {
