...
function Adapter(options) {
    ...
    const initObjects = (cb) => {
        ...
        const setObjectWithDefaultValue = (id, obj, options, callback) => {
            ...
            if (!id) {
                callback && callback('setObjectWithDefaultValue id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
            }
        ...
        this.setObject = (id, obj, options, callback) => {
            ...
            if (!id && obj.type !== 'meta') {
                ...
                return typeof callback === 'function' && callback('id missing!');
            }
        ...
        this.extendForeignObject = (id, obj, options, callback) => {
            ...
            if (!id) {
                callback && callback('extendForeignObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getObject = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('getObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.findForeignObject = (id, type, options, callback) => {
            ...
            if (!id) {
                callback && callback('findForeignObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getForeignObject = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('getForeignObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.delObject = (id, options, callback) => {
            if (!id) {
                callback && callback('delObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.delForeignObject = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('delForeignObject id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setObjectNotExists = (id, obj, options, callback) => {
            ...
            if (!id) {
                callback && callback('setObjectNotExists id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setForeignObjectNotExists = (id, obj, options, callback) => {
            ...
            if (!id) {
                callback && callback('setForeignObjectNotExists id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
    ...
    const initStates = (cb) => {
        ...
        this.setState = (id, state, ack, options, callback) => {
            ...
            if (!id) {
                callback && callback('setState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setStateChanged = (id, state, ack, options, callback) => {
            ...
            if (!id) {
                callback && callback('setStateChanged id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setForeignState = (id, state, ack, options, callback) => {
            ...
            if (!id) {
                callback && callback('setForeignState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setForeignStateChanged = (id, state, ack, options, callback) => {
            ...
            if (!id) {
                callback && callback('setForeignStateChanged id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getState = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('getState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getForeignState = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('getForeignState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getHistory = (id, options, callback) => {
            if (!id) {
                callback && callback('getHistory id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.delState = (id, options, callback) => {
            if (!id) {
                callback && callback('delState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.delForeignState = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('delForeignState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.setBinaryState = (id, binary, options, callback) => {
            ...
            if (!id) {
                callback && callback('setBinaryState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.getBinaryState = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('getBinaryState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
        ...
        this.delBinaryState = (id, options, callback) => {
            ...
            if (!id) {
                callback && callback('delBinaryState id missing');
                return;
            }
            if (typeof id !== 'string') {
                return callback(`ID can be only string and not "${typeof id}"`);
