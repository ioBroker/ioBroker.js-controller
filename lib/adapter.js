    ...
    const initObjects = cb => {
        ...
        const setObjectWithDefaultValue = (id, obj, options, callback) => {
            ...
            try {
                ...
                typeof callback === 'function' && setImmediate(() => callback(err.message));
                return;
            }
        ...
        this.extendObject = async (id, obj, options, callback) => {
            ...
            if (obj && (
                ...
                try {
                    ...
                    await adapterObjects.setObjectAsync(id, obj, options);
                    if (defState !== undefined) {
                        ...
                        if (!currentState) {
                            try {
                                await this.setForeignStateAsync(id, defState);
                            } catch (e) {
                                logger.debug(`Default value for State ${id} could not be set: ${e}`);
                            }
                        }
                    }
                ...
                try {
                    await adapterObjects.extendObjectAsync(id, obj, options);
                    if (!oldObj && obj.common && obj.common.def !== undefined) {
                        await this.setForeignStateAsync(id, obj.common.def);
                    }
                    typeof callback === 'function' && callback();
                } catch (e) {
                    typeof callback === 'function' && callback(e);
