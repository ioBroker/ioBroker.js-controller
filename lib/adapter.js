...
function Adapter(options) {
        ...
        that.extendObject = function extendObject(id, obj, callback) {
            ...
            if (obj && (obj.children || (obj.common && (obj.common.repositories || obj.common.members || obj.common.certificates)))) {
                ...
                that.objects.getObject(id, function (err, oldObj) {
                    ...
                    if (obj.common.repositories && oldObj.common && oldObj.common.repositories) {
                        oldObj.common.repositories = [];
                    }
                    if (obj.common.members && oldObj.common && oldObj.common.members) {
                        oldObj.common.members = [];
                    }
                    if (obj.common.certificates && oldObj.common && oldObj.common.certificates) {
    ...
    function initAdapter(adapterConfig) {
        ...
        if (!adapterConfig || !adapterConfig.common || !adapterConfig.common.enabled){
            logger.error('invalid config or adapter disabled');
            process.exit(1);
            return;
        }
