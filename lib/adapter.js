...
function Adapter(options) {
    ...
    const initObjects = cb => {
        ...
        // TODO: remove this backward compatibility shim in the future
        this.states.getState = (id, options, callback) => {
            this.log.warn('adapter.states.getState is deprecated, and will be removed in the future. Please use adapter.getObjectView/Async. Report this to Developer!');
            return this.getState(id, options, callback);
        };
