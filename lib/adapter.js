                    ...
                    if (state.val !== null) {
                        ...
                        if (!(obj.common.type === 'mixed' && typeof state.val !== 'object' ||
                            ...
                            if (['object', 'json', 'file', 'array'].includes(obj.common.type)) {
                                ...
                                logger.warn(`${this.namespaceLog} State value to set for "${id}" has wrong type "${typeof state.val}" but has to be ${obj.common.type === 'mixed' ? `one of "string", "number", "boolean"` : `"${obj.common.type}"`}`);
                            }
                        }
