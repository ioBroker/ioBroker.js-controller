    ...
    this.init = function () {
        ...
        server.on('listening', function () {
            try {
                ...
                logger.warn('host.' + hostname + ' Multihost discovery server: Multicast membership could not be added.');
            }
            const address = server.address();
            logger.info('host.' + hostname + ' Multihost discovery server: service started on ' + address.address + ':' + address.port);
        });
