...
const sfs = require('safe-replace');
...
function writeRenewalConfig(args) {
    ...
    const pyconf = PromiseA.promisifyAll(require('pyconf'));
    ...
    const store = {
        ...
        , accounts: {
            ...
            _getAccountKeyPath: function (args) {
                let promise = PromiseA.resolve(args.accountId);
            ...
            , getAccountIdAsync: function (args) {
                ...
                return pyconf.readFileAsync(args.renewalPath).then(function (renewal) {
                    const accountId = renewal.account;
                    return accountId;
                }, function (err) {
                    if ('ENOENT' === err.code) {
