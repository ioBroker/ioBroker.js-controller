        ...
        if (userOptions.transport) {
            ...
            for (const f in userOptions.transport) {
                ...
                if (userOptions.transport[f].type === 'file' && userOptions.transport[f].enabled !== false) {
                    ...
                    userOptions.transport[f].createSymlink = (userOptions.transport[f].createSymlink !== undefined) ? userOptions.transport[f].createSymlink : !isWindows;
                    ...
                    userOptions.transport[f].zippedArchive = !isWindows;
