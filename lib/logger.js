        ...
        if (userOptions.transport) {
            ...
            for (const f in userOptions.transport) {
                ...
                if (userOptions.transport[f].type === 'file' && userOptions.transport[f].enabled !== false) {
                    ...
                    userOptions.transport[f].symlinkName = (userOptions.transport[f].symlinkName !== undefined) ? userOptions.transport[f].symlinkName : (userOptions.transport[f].filename + '.current.json');
