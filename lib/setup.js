...
function initYargs() {
    ...
    // TODO: These commands should have an explanation
        .usage('Commands:\n' +
                ...
                tools.appName + ' update [repository url] [--updatable/--u] [--installed/--i] - update repository and optionally filter installed/updateable adapters\n' +
                ...
                tools.appName + ' object set <id> <json-value> - set object specified to id by providing a new json object\n' +
