...
function processCommand(command, args, params, callback) {
    ...
    /** Wrapper around dbConnect(params, () => ...)
     * @type {(callback: import('./cli/cliCommand').DBActionCallback) => void}
     */
    const dbAction = (callback) => {
        dbConnect(params, () => {
    ...
    switch (command) {
        ...
        case 'o':
        case 'object': {
            const objectsCommand = new cli.command.object(
                Object.assign({}, params, commandContext)
            );
        ...
        case 's':
        case 'state': {
            const statesCommand = new cli.command.state(
                Object.assign({}, params, commandContext)
            );
