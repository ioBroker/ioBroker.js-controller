...
switch (yargs.argv._[0]) {
            ...
            dbConnect(function () {
                ...
                if (!fs.existsSync(adapterDir)) {
                    install.downloadPacket(repoUrl, name, {useSystemNpm: false}, function () {
                        if (yargs.argv._[0] !== 'install' && yargs.argv._[0] !== 'i') {
                    ...
                    dbConnect(function () {
                        objects.delObject('system.meta.uuid', function (err) {
                            ...
                            objects.getObject('system.config', function (err, obj) {
                                if ( obj.common.licenseConfirmed || obj.common.language) {
                                    ...
                                    objects.setObject('system.config', obj, function (err) {
                                        if (err) {
                                            ...
                                            console.log('system.config reseted');
                                            processExit();
                                        }
                                    });
                                } else {
    ...
    case 'adduser':
        (function () {
            ...
            addUser(user, group, password, function (err) {
                if (err) {
                    console.error(err);
                    processExit(30);
                } else {
    ...
    case 'passwd':
        (function () {
            ...
            setUserPassword(user, password, function (err) {
                if (err) {
                    console.error(err);
                    processExit(30);
                } else {
    ...
    case 'repo':
        (function () {
            Objects =       require(__dirname + '/objects');
            var repoName =   yargs.argv._[1]; // Repo url or name
            dbConnect(function () {
