...
switch (yargs.argv._[0]) {
    ...
    case 'update':
        (function () {
            ...
            dbConnect(function () {
                var Repo = require(__dirname + '/setupRepo.js');
                var repo = new Repo({
                    dbConnect:   dbConnect,
                    processExit: processExit
                });

                repo.showRepo(repoUrl, function () {
                    setTimeout(function () {
                        processExit();
                    }, 2000);
                });
    ...
    case 'setup':
        (function () {
            if (yargs.argv._[1] == 'custom') {
                ...
                var Setup = require(__dirname + '/setupSetup.js');
                var setup = new Setup({
                    dbConnect:   dbConnect,
                    processExit: processExit
                });
    ...
    case 'upgrade':
        (function () {
            ...
            dbConnect(function () {
                var Upgrade = require(__dirname + '/setupUpgrade.js');
    ...
    case 'restore':
        (function () {
             var Backup = require(__dirname + '/setupBackup.js');
                    ...
                    if (!password) {
                        ...
                        prompt.get(schema, function (err, result) {
                            if (result) {
                                ...
                                var Users = require(__dirname + '/setupUsers.js');
                                var users = new Users({
                                    objects:     objects,
                                    processExit: processExit
                                });
