...
const cli_msg = require('./cli/messages');
                    ...
                    if (cmd === 'get') {
                        ...
                        dbConnect(params, () => {
                            objects.getObject(id, (err, res) => {
                                if (err || !res) {
                                    console.log(cli_msg.error_objectNotFound(id, err));
                                    callback(3);
                                    return;
                                } else {
                                    if (typeof propPath === 'string') {
                                        ...
                                        try {
                                            ...
                                            console.log(cli_msg.error_objectPropertyNotFound(id, propPath));
                                            callback(3);
                                            return;
                                        }
                                    }
                        ...
                        if (!parsedArg) {
                            console.log(cli_msg.error_invalidPropertyOrValue());
                            callback(3);
                            return;
                        }
                        ...
                        dbConnect(params, () => {
                            function doSetObject(obj) {
                                objects.setObject(id, obj, () => {
                                    console.log(cli_msg.success_objectUpdated(id));
                                    callback();
                                    return;
                                });
                            }
                        ...
                        dbConnect(params, () => {
                            objects.delObject(id, err => {
                                if (err) {
                                    ...
                                    console.log(cli_msg.success_objectDeleted(id));
                                    callback();
                                    return;
                                }
                            });
                        ...
                        console.log(cli_msg.error_unknownCommand('object', cmd));
                        callback(3);
                        return;
                    }
                }
                    ...
                    dbConnect(params, () => {
                        if (cmd === 'get') {
                            states.getState(id, (err, obj) => {
                                if (err || !obj) {
                                    console.log(cli_msg.error_stateNotFound(id, err));
                                } else {
                                    if (params.pretty) {
                            ...
                            states.delState(id, err => {
                                if (err) {
                                    ...
                                    console.log(cli_msg.success_stateDeleted(id));
                                    callback();
                                }
                            });
                        }
                            ...
                            console.log(cli_msg.error_unknownCommand('state', 'cmd'));
                            showHelp();
                            callback(1);
                        }
                    });
