...
function initYargs() {
    yargs = require('yargs')
        ...
        .command('upgrade', 'Upgrade management', yargs => {
            yargs
                .command('[<repositoryUrl>]', 'Upgrade all adapters from given repository', {
                    yes: {
                ...
                .command('self [<repositoryUrl>]', 'Upgrade js-controller and all adapters, optionally you can specify the repository url', {
                    force: {
