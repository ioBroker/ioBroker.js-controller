...
function initYargs() {
    ...
    // TODO: These commands should have an explanation
        .usage('Commands:\n' +
                ...
                tools.appName + ' upgrade [repository url] [--yes/-y]\n' +
                tools.appName + ' upgrade self [repository url] [--force/-f] - upgrade js-controller and all adapters, optionally you can specify the repository url\n' +
                tools.appName + ' upgrade <adapter> [repository url] [--yes/-y] - upgrade specified adapter, optionally you can specify the repository url\n' +
                ...
                tools.appName + ' object del <id|pattern> [--yes/-y]\n' +
            ...
            dbConnect(params, async (objects, _states, isOffline, objectType) => {
                if (cmd === 'read' || cmd ==='r') {
                    ...
                    try {
                        ...
                        console.warn(`Could not create directory "meta.user": ${e}`);
                    }
                    ...
                    try {
                        ...
                        console.error(`Error on sync: ${err}. Partial content might have been synced.`);
                        return void callback(1);
                    }
                } else {
                    console.log('Invalid parameters: write "file read /vis.0/main/img/picture.png /opt/picture/image.png" to read the file from DB and store it on disk');
