                ...
                switch (type) {
                        ...
                        objects.getObjectList({startkey: 'system.group.', endkey: 'system.group.\u9999'}, function (err, objs) {
                            ...
                            for (var i = 0; i < objs.rows.length; i++) {
                                ...
                                if (!reg || reg.test(objs.rows[i].value._id) || (objs.rows[i].value.common && reg.test(objs.rows[i].value.common.name))) {
                                    ...
                                    console.log(text);
                                    console.log('object  | state   | file      | user  | others ');
                                    console.log('l r w d | l r w d | l r w c d | w c d | others ');
                                    var text = '';
                                    if (objs.rows[i].value.common.acl) {
                                        if (objs.rows[i].value.common.acl.object) {
                                            text + = ' ';
                                        ...
                                        if (objs.rows[i].value.common.acl.state) {
                                            text + = ' ';
                                        ...
                                        if (objs.rows[i].value.common.acl.file) {
                                        ...
                                        if (objs.rows[i].value.common.acl.user) {
                                        ...
                                        if (objs.rows[i].value.common.acl.other) {
                                            for (var r in objs.rows[i].value.common.acl.other) {
                                                text += r + (objs.rows[i].value.common.acl.other[r] ? '+' : '-');
                                            }
                                            text += ' |';
                                        } else {
                                            text += '     |';
                    ...
                    default:
                        if (type) {
                            ...
                            console.log('Please specifiy type: objects, states, instances, adapters, users, groups, enums, files');
                        }
                        break;
                }
            });
