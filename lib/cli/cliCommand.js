/**
 * @typedef {(objects: ioBroker.ObjectsDB, states: ioBroker.StatesDB, isOffline: boolean, objectsDBType: string, config: Record<string, any>) => void} DBConnectCallback
 */

/**
 * @typedef CLICommandContext
 * @property {(callback: DBConnectCallback) => void} dbConnect - Invoke this before doing anything in the database
 * @property {(code?: number) => void} callback
 * @property {() => void} showHelp
 */

/**
 * @typedef CLICommandParams
