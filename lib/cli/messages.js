...
const errorMessages = Object.freeze({
    stateNotFound: (
        /** @type {string} */ stateID,
        /** @type {Error?} */ error
    ) => `The state ${stateID} was not found!` + (error ? ` Reason: ${error.message}` : ''),
    objectNotFound: (
        /** @type {string} */ objectID,
        /** @type {Error?} */ error
    ) => `The object ${objectID} was not found!` + (error ? ` Reason: ${error.message}` : ''),
    cannotUpdateObject: (
        /** @type {string} */ objectID,
        /** @type {Error?} */ error
    ) => `The object ${objectID} could not be updated!` + (error ? ` Reason: ${error.message}` : ''),
    cannotDeleteObject: (
        /** @type {string} */ objectID,
        /** @type {Error?} */ error
    ) => `The object ${objectID} cannot be deleted!` + (error ? ` Reason: ${error.message}` : ''),
    cannotDeleteObjectFromEnums: (
        /** @type {string} */ objectID,
        /** @type {Error?} */ error
    ) => `The object ${objectID} could not be deleted from enums!` + (error ? ` Reason: ${error.message}` : ''),
    cannotChangeObject: (
        /** @type {string} */ objectID,
        /** @type {Error?} */ error
    ) => `The object ${objectID} cannot be changed!` + (error ? ` Reason: ${error.message}` : ''),
