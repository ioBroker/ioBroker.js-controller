...
function Repo(options) {
    ...
    function updateRepo(repoUrl, callback) {
        ...
        if (!repoUrl || typeof repoUrl !== 'object') {
            tools.getRepositoryFile(repoUrl, (err, sources) => updateRepo(sources, callback));
            return;
        }
        ...
        function download() {
            if (downloads.length < 1) {
                ...
                if (sources[name].version) {
                    ...
                    tools.getJson(sources[name].meta, ioPack => {
                ...
                if (err || !obj) {
                    ...
                    if (!obj.native || !obj.native.repositories) {
                        ...
                        if (obj.native.repositories[repoUrl]) {
                            ...
                            updateRepo(obj.native.repositories[repoUrl].link, sources => {
