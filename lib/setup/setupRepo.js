...
function Repo(options) {
    ...
    function updateRepo(repoUrl, sourcesHash, callback) {
        const result = {};
        ...
        if (!repoUrl || typeof repoUrl !== 'object') {
            tools.getRepositoryFile(repoUrl, (err, sources, sourcesHash) => updateRepo(sources, sourcesHash, callback));
            return;
        }
                ...
                if (err || !obj) {
                    ...
                    if (!obj.native || !obj.native.repositories) {
                        ...
                        if (obj.native.repositories[repoUrl]) {
                            ...
                            updateRepo(obj.native.repositories[repoUrl].link, (sources, sourcesHash) => {
