...
function Setup(options) {
    ...
    this.setupCustom = function (callback) {
        ...
        if (oSentinel) {
            oSentinelName = rl.question('Objects Redis Sentinel Master Name [' + oSentinelName + ']: ', {
                defaultInput: (originalConfig.objects.options && originalConfig.objects.options.name) ? originalConfig.objects.options.name : 'mymaster'
            });
        }
        ...
        if (sSentinel) {
            sSentinelName = rl.question('States Redis Sentinel Master Name [' + oSentinelName + ']: ', {
                defaultInput: (originalConfig.states.options && originalConfig.states.options.name) ? originalConfig.states.options.name : (oSentinelName && oport === sport) ? oSentinelName: 'mymaster'
            });
        }
