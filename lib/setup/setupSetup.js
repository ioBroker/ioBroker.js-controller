...
function Setup(options) {
                        ...
                        dbConnect(Object.assign(params, {timeout: 60000}), (objects, states) => {
                            ...
                            backup.restoreBackup(filePath, err => {
                                ...
                                if (!err) {
                                    ...
                                    console.log('"iobroker upload all" on all other hosts before you continue!');
                                }
                                callback(err ? 78 : 0);
                            });
                        });
    ...
    this.setupCustom = function (callback) {
        ...
        let otype = rl.question('Type of objects DB [(f)ile, (r)edis], default [file]: ', {
            defaultInput: 'file'
        });
        ...
        let ohost = rl.question('Host / Unix Socket of objects DB(' + otype + '), default[127.0.0.1]: ', {
            defaultInput: '127.0.0.1'
        });
        ...
        const userObjPort = rl.question('Port of objects DB(' + otype + '), default[' + op + ']: ', {
            defaultInput: op,
            limit: /^[0-9, ]+$/
        });
        let oport;
        ...
        let stype = rl.question('Type of states DB [(f)file, (r)edis], default [' + otype + ']: ', {
            defaultInput: otype
        });
        ...
        let shost = rl.question('Host / Unix Socket of states DB (' + stype + '), default[' + (Array.isArray(ohost) ? ohost.join(',') : ohost) + ']: ', {
            defaultInput: ohost
        });
        ...
        const userStatePort = rl.question('Port of states DB (' + stype + '), default[' + sp + ']: ', {
            defaultInput: sp,
            limit: /^[0-9, ]+$/
        });
        let sport;
