...
function Setup(options) {
     ...
     * @param {import("readline-sync")} rl - readline object
    ...
    function migrateObjects(newConfig, oldConfig, rl, callback) {
        ...
        if (oldConfig && ((oldConfig.states.type !== newConfig.states.type || oldConfig.objects.type !== newConfig.objects.type) ||
            (oldConfig.states.type === 'redis' && oldConfig.states.host !== newConfig.states.host) ||
            (oldConfig.objects.type === 'redis' && oldConfig.objects.host !== newConfig.objects.host))) {
