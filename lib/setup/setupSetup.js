...
function Setup(options) {
    ...
    this.setupCustom = function (callback) {
        ...
        if (oSentinel) {
            const defaultSentinelName = (originalConfig.objects.options && originalConfig.objects.options.name) ? originalConfig.objects.options.name : 'mymaster';
        ...
        if (sSentinel) {
            const defaultSentinelName = (originalConfig.states.options && originalConfig.states.options.name) ? originalConfig.states.options.name : (oSentinelName && oport === sport) ? oSentinelName: 'mymaster';
