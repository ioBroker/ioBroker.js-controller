...
class NotificationHandler {
     ...
     *
     * @param {string} scope - scope of notifications
     * @param {string} category - category of notifications
     * @param {string} instance - instance of notifications
     * @return {object}
     */
    getFilteredInformation(scope, category, instance) {
     ...
     * @param {string} instance - instance of notifications
     */
    clearNotifications(scope, category, instance) {
