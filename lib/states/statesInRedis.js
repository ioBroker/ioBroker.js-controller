...
class StateRedis {
    ...
    constructor(settings) {
        ...
        this.client.on('end', () => {
            console.log('States-Redis end (' + this.stop + ')');
            if (ready && typeof this.settings.disconnected === 'function') this.settings.disconnected();
        });

        this.client.on('connect', () => {
            console.log('States-Redis connect (' + this.stop + ')');
            connected = true;
        });

        this.client.on('close', () => {
            console.log('States-Redis close (' + this.stop + ')');
            if (ready && typeof this.settings.disconnected === 'function') this.settings.disconnected();
        });
        ...
        this.client.on('reconnecting', () => {
            ...
            connected = false;
            initError = false;
            console.log('States-Redis client will try to reconnect (' + this.stop + ')');
        });
