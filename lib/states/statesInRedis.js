...
class StateRedis {
     ...
     * @param {function(String):void} [callback] cb function to be executed after keys have been deleted
     * @private
     */
     ...
     * @method destroyDB
     *
     * @param {function(String):void} [callback] cb function to be executed after DB has been destroyed
     */
    destroyDB(callback) {
        if (!this.client) {
            typeof callback === 'function' && setImmediate(() => callback(tools.ERRORS.ERROR_DB_CLOSED));
        } else {
            this.client.keys(`${this.namespaceRedis}*`, (err, keys) =>
