...
class StatesInMemoryFileDB extends InMemoryFileDB {
    ...
    expireSession(id) {
        if (this.sessionExpires[id] !== undefined) {
    ...
    getState(id, callback) {
        typeof callback === 'function' && setImmediate(() => callback(null, this.dataset[id] !== undefined ? this.dataset[id] : null));
    }
    ...
    lenMessage(id, callback) {
        ...
        typeof callback === 'function' && setImmediate(() => callback(tools.ERRORS.ERROR_NOT_FOUND, null));
        //}
    }
    ...
    lenLog(id, callback) {
        if (this.logs[id]) {
            typeof callback === 'function' && setImmediate(() => callback(null, this.logs[id].length, id));
        } else {
    ...
    getLog(id, callback) {
        if (this.logs[id]) {
            typeof callback === 'function' && setImmediate(() => callback(null, this.logs[id].pop(), this.logs[id].length));
        } else {
    ...
    getSession(id, callback) {
        typeof callback === 'function' && setImmediate(() => callback(this.session[id]));
    }
