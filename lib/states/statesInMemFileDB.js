...
class StatesInMemoryFileDB extends InMemoryFileDB {
    ...
    lenMessage(id, callback) {
        if (this.messagebox[id]) {
            if (typeof callback === 'function') callback(null, this.messagebox[id].length);
        } else {
    ...
    getMessage(id, callback) {
        if (this.messagebox[id]) {
            if (typeof callback === 'function') callback(null, this.messagebox[id].pop());
        } else {
            if (typeof callback === 'function') callback(tools.ERRORS.ERROR_NOT_FOUND, null);
        }
    }
    ...
    unsubscribeMessage(client, id, cb) {
    ...
    lenLog(id, callback) {
        if (this.logs[id]) {
            if (typeof callback === 'function') callback(null, this.logs[id].length, id);
        } else {
    ...
    getLog(id, callback) {
        if (this.logs[id]) {
            if (typeof callback === 'function') callback(null, this.logs[id].pop(), this.logs[id].length);
        } else {
    ...
    getSession(id, callback) {
        if (typeof callback === 'function') callback(this.session[id]);
    }
