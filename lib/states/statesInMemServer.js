...
function StatesInMemory(settings) {
    ...
    this.lenMessage = function (id, callback) {
        if (messagebox[id]) {
            ...
            if (typeof callback === 'function') callback(tools.ERRORS.ERROR_NOT_FOUND, null);
        }
    };
    ...
    this.delMessage = function (id, messageId, callback) {
        if (messagebox[id]) {
            ...
            if (!found) {
                ...
                if (typeof callback === 'function') callback(tools.ERRORS.ERROR_NOT_FOUND);
            } else {
    ...
    this.lenLog = function (id, callback) {
        if (logs[id]) {
            ...
            if (typeof callback === 'function') callback(tools.ERRORS.ERROR_NOT_FOUND, null, id);
        }
    };
    ...
    this.getLog = function (id, callback) {
        if (logs[id]) {
            ...
            if (typeof callback === 'function') callback(tools.ERRORS.ERROR_NOT_FOUND, null, 0);
        }
    };
