...
/**
 * Set capabilities of the node executable on Linux systems
 ...
 */
async function setNodeCapabilities(capabilities, modeEffective, modePermitted, modeInherited) {
    ...
    if (os.platform() === 'linux') {
        if (Array.isArray(capabilities) && capabilities.length) {
            ...
            await cpPromise.exec(`sudo setcap ${capabilitiesStr}${modes} ${process.execPath}`);
        } else {
