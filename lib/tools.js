...
function scanDirectory(dirName, list, regExp) {
    if (fs.existsSync(dirName)) {
        ...
        try {
            ...
            console.log('Cannot read or parse ' + dirName + ': ' + e.toString());
            return;
        }
 ...
 * @param checkIfLocalOnly {boolean} if try the method checks if the server listens to local connections only; else also external connection options are checked
