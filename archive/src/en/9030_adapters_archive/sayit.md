...
To use the engine Amazon Speech Cloud one should receive Access Key and Secret Key. To do this we register on <span style="text-decoration: underline;">site project</span>- link Sign up: [
