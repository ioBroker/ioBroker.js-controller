...
Если вы выберете вкладку ***ANY*** , вы можете ввести любой путь к файлу или URL-адрес (например, URL-адрес для внешнего разработчика адаптера) в поле и установить соответствующий адаптер.
