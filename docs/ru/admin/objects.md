...
Эти объекты (и их каталоги) являются системными объектами и не должны использоваться для обычного использования, поскольку изменение / обновление администратора может привести к структурному изменению и, следовательно, потере данных личных данных.
...
Существующие объекты показаны в таблице на странице.
