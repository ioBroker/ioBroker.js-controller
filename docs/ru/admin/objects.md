...
Эти объекты (и их каталоги) являются системными объектами и не должны использоваться для обычного использования, поскольку изменение / обновление администратора может привести к структурным изменениям и, следовательно, потере данных личных данных.
...
Теперь необходимо выбрать имя для нового объекта, чтобы устройство, канал или точка данных были доступны как тип в соответствии с иерархической структурой. Логическое значение, переключатель, строка, число, список значений, поле, объект и смешанные данные доступны в качестве типов точек данных.
