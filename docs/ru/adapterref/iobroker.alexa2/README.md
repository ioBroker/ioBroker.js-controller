...
Большое спасибо soef за хорошую версию 1 адаптера и Hauke и ruhr70 за идеи в их сценариях от ioBroker-Forum (особенно обновления медиа-прогресса)! Также большое спасибо meicker за поддержку в документировании всего этого и многочисленным пользователям ioBroker Forum за поддержку тестирования!
...
Вы можете использовать один или несколько таймеров на каждом устройстве Alexa. Из-за очень динамичной природы таймеров не будет никаких других объектов, созданных, как с помощью Alarm или Reminders, но существует способ получить информацию о срабатывании.
...
* если это все еще не работает, сделайте это снова и проверьте User-Agent и accept-Language из вашего браузера и используйте их в адаптере при следующей попытке
