...
В зависимости от возраста вашей установки ioBroker пользователь `iobroker` (или другой пользователь ioBroker) может не иметь надлежащих прав для доступа к I2C.
