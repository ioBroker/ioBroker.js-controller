...
В настоящее время поддерживаются следующие устройства. Цифры в скобках - это известные адреса устройства в шестнадцатеричном формате (без бит чтения).
...
## Совместимость
Совместимость проверена с Raspberry Pi 3.
...
## ДЕЛАТЬ
* Поддержка прерываний вместо только опроса для MCP230xx и PCF8574

## Спасибо
Этот проект основан на модуле NPM [i2c шины](https://www.npmjs.com/package/i2c-bus). Спасибо fivdi за его отличный модуль!
