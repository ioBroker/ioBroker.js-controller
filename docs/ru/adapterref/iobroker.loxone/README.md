...
![Известные уязвимости](https://snyk.io/test/github/UncleSamSwiss/ioBroker.loxone/badge.svg)
...
Имейте в виду, что этот пароль хранится незащищенным внутри ioBroker - поэтому не используйте пользователя «admin»!
...
- один канал на каждый час прогноза под названием `HourXX`, где` XX` - количество часов с этого момента
