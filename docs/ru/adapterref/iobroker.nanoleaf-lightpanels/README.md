...
Это адаптер ioBroker для управления световыми панелями nanoleaf (ранее nanoleaf Aurora) или холстом nanoleaf через nanoleaf OpenAPI.
...
2. OpenAPI nanoleaf требуется токен авторизации для предоставления доступа к OpenAPI. Если он у вас уже есть, вы можете ввести здесь токен и пропустить следующий шаг.
