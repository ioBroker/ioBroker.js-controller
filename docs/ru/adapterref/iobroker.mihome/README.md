...
* Включите ползунковый переключатель выше, запомните пароль и подтвердите, нажав «OK».
...
появляются другие пункты меню> Если сразу не работает, повторите шаги
...
IP-адрес шлюза, используемого шлюзом, можно определить в тексте после _localip_ в разделе About / Hub info. В используемом маршрутизаторе этот IP-адрес должен быть постоянно назначен шлюзу.
