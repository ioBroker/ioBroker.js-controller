...
# IoBroker Mi Home Adapter С помощью Mi Home Adapter Mi Control Hub (шлюз) интегрирован в систему ioBroker и обеспечивает связь между различными датчиками, переключателями Xiaomi и т. д.
