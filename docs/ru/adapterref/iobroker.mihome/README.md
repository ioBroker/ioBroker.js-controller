...
IP-адрес используемого им шлюза можно определить в тексте после _localip_ в разделе About / Hub info. В используемом маршрутизаторе этот IP-адрес должен быть постоянно назначен шлюзу.
