...
ioBroker может, например, освещение и громкоговоритель шлюза можно контролировать.
...
* Включите ползунковый переключатель выше, запомните пароль и подтвердите, нажав «ОК».
...
IP-адрес шлюза, который используется шлюзом, можно определить в тексте после _localip_ в разделе About / Hub info. В используемом маршрутизаторе этот IP-адрес должен быть постоянно назначен шлюзу.
...
- ctrl_ln2 - Двойная клавиша выключателя нулевого огня Xiaomi 86
...
Инструкции составлены на основе наших знаний и убеждений.
