...
1. а) Введите IP-адрес для deConz
    ...
    б) Введите порт, если вы его изменили, стандарт 80.

2. После ввода и сохранения IP-адреса и порта нажмите кнопку «Создать ключ API». Теперь вы можете ввести учетные данные для deConz или зайти в приложение Phoscon APP и зарегистрировать ioBroker в качестве стороннего приложения.
