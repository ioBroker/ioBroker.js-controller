...
5. Наконец, вы должны быть полностью настроены: адаптер сгенерирует все объекты для управления вашими устройствами Hue соответственно.
...
| __Игнорировать группы__ | Если установлен этот флажок, группы не будут отображаться / контролироваться адаптером. |
...
| __Нативное включение / выключение поведения__ | Если этот флажок установлен, адаптер будет включать / выключать подсветку так же, как и собственное приложение Hue. В противном случае лампы будут установлены на уровень 100% при включении. |
