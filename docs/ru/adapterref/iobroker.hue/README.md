...
| __Нативное включение / выключение поведения__ | Если этот флажок установлен, адаптер будет включать / выключать свет таким же образом, как и собственное приложение Hue. В противном случае лампы будут установлены на уровень 100% при включении. |
