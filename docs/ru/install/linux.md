...
только если **ВСЕ** эти команды не дают никакого результата (т. е. больше не отображают номер версии), переходите к шагу 4 этого раздела, в противном случае или если версия не соответствует желаемой, сделайте заранее следующее:
