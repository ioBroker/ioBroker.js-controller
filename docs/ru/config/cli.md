...
- [обновление iobroker \ [URL-адрес хранилища \] \ [- обновляемый \]] (# iobroker-update-repository-url)
- [Обновление iobroker \ [URL хранилища \]] (# обновление iobroker)
- [iobroker upgrade self \ [url хранилища \]] (# iobroker-upgrade-self)
...
- [Информация о iobroker] (# информация о iobroker)
...
## Журналы iobroker
Показать последние строки журнала ioBroker. Эта команда показывает последние 1000 строк журнала и отслеживает журнал.
