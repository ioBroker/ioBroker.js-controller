...
### Предисловие:
Так как некоторым пользователям очень сложно восстановить, пошаговые инструкции по восстановлению после сбоя или после смены оборудования, системы или чего-то еще должны помочь.
