...
После этого можно приступать к фактическому восстановлению.
...
Пожалуйста, не перезапускайте ioBroker, самое большее время от времени обновляйте представление с помощью F5, пока все экземпляры не будут снабжены значком.
...
Вы можете восстановить базу данных Redis, базу данных Zigbee, базу данных mySql и свои данные истории с помощью тех же шагов, которые описаны выше.
...
Если у вас мало опыта работы с командами терминала и вы чувствуете себя небезопасно, вы в безопасности с Backitup.
