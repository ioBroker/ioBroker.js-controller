...
Если вам больше не нужно иметь доступ к старой системе и вы не знаете, что именно было настроено ранее, то заранее установите сервер Redis.
...
С помощью этой команды нельзя создать резервную копию Redis, резервную копию Zigbee, резервную копию mySql или данные истории.
