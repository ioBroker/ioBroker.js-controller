...
Если вы не уверены, что Redis использовался и все еще имеет доступ к старой системе, тогда получите необходимую информацию с помощью команды `iobroker status` «Вывод выглядит так при использовании Redis:
