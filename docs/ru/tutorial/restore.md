...
### Предисловие:
Поскольку некоторые пользователи находят восстановление очень трудным, пошаговое руководство по восстановлению после сбоя или после смены оборудования, изменения системы или чего-либо еще должно помочь.
...
Поздравляем, недавно установленная система в комплекте со всеми настройками, скриптами, визуализациями и т. Д.
...
Список полученных резервных копий будет выглядеть следующим образом в примере.
...
После этого проверьте, остановлено ли все, с помощью следующих команд:
