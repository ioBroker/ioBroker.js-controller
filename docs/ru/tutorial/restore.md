...
### Предисловие:
Поскольку некоторые пользователи считают, что восстановление очень сложно, пошаговое руководство по восстановлению после сбоя или после замены оборудования, изменения системы или чего-либо еще должно помочь.
...
Если нет уверенности в том, что Redis использовался и доступ к старой системе все еще существует, используйте команду `iobroker status` для получения необходимой информации. «Выходные данные выглядят следующим образом при использовании Redis:
