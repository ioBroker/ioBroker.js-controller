...
После завершения установки вы можете сохранить «Резервное копирование ioBroker», созданное старой системой, в новой системе, используя программу sftp, такую как FileZilla или WinSCP, в пути / opt / iobroker / backups.
