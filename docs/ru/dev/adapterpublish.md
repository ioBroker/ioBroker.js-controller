...
8. Состояния, созданные адаптером, должны предоставлять действительную информацию для вашего
...
9. Адаптер должен использовать оба теста, указанные в шаблоне. Для этого аккаунт Github с Appveyor
...
10. В io-package.json должна быть сделана хотя бы одна запись под общим для атрибута «авторы». также
...
12. Организация ioBroker должна быть добавлена в npm. Это необходимо для обеспечения долгосрочного обслуживания пакета
...
- **сад** - з. B. газонокосилки, спринклерные системы
...
- **обмен сообщениями** - адаптер для отправки и получения сообщений, например Б. по электронной почте, телеграмме, ...
- **misc-data** - экспорт и импорт данных, конвертер валют и т. д.
- **мультимедиа** - телевизор, AVR, коробки, голосовые помощники и т. д.
...
- **Утилита** - Поддержка адаптеров, таких как B. Резервное копирование
