...
| ммм | display.maintenance.mmm | | | | ммм = низкий бит или недостигнут или что-то |
...
* `common.logTransporter` - если этот адаптер получает журналы от других хостов и адаптеров (например, для их просмотра)
