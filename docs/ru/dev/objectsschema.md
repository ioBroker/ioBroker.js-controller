...
## Идентификаторы
Идентификатор - это строка длиной не более 240 байтов, иерархически структурированная, уровни разделены точками.
...
* `common.history. <HISTORY-INSTANCE> .enabled` (булево)
