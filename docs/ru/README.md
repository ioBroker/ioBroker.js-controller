...
Система ioBroker имеет модульную структуру. Множество [адаптеров] [] обеспечивает связь с более чем 400 различными платформами от A для Alexa до Z для Z-Wave.
