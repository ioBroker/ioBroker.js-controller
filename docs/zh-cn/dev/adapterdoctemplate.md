...
＃ <img src="media/{Adaptericon}" width=150 hight=150/> （名称）的转接适配器
本节提供适配器预期用途的最终用户友好摘要。此摘要应保持简短（最多1-3个小段）。它应该包含如此多的信息，以引起用户的兴趣，并且他可以决定适配器是否与他相关。

有关适配器和任何设备的技术背景信息，请参见“概述”部分。

<!-- Einführungsbild--> ![{旧图片名称}](../../de/dev/media/{Bild} "{图像描述") <span style="color:grey">* {image description} *</span>
...
### Window“{Window title}”
![{Alt键名}](../../de/dev/media/{Formularfelderbild} "{图像}说明") <span style="color:grey">* {image description} *</span>
...
![例](../../de/dev/media/a_harmony_instanz.png "例") <span style="color:grey">*初审*</span>
...
![老物件名称](../../de/dev/media/{Bildname} "“{图片}说明") <span style="color:grey">* {image description} *</span>
