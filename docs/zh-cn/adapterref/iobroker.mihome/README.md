...
#### IOS
* [iOS应用]（https://itunes.apple.com/de/app/mi-home-xiaomi-smarthome/id957323480?mt=8）下载，安装，打开并
...
如果您不再希望通过该应用操作示教设备，则在路由器中示教所有设备后，也可以关闭网关的Internet访问。
...
-remote.b286acn01-小米Aqara无线遥控器（双翘板）
