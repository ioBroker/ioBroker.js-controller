...
These objects (and their directories) are system objects and should not be used for normal use, since a change / an update of the admin can lead to a structural change and thus data loss of personal data.
