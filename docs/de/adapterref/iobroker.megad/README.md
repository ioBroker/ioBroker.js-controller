...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.megad/README.md
title: kein Titel
hash: ukQz4Z7heTE/fNMzOhsx6fPwXwoF/mzDxc9CDSpp0oc=
---
![Logo](../../../en/adapterref/iobroker.megad/admin/megad.png) ioBroker MegaD-328 Adapter ===================

![Anzahl der Installationen](http://iobroker.live/badges/megad-stable.svg)
![NPM-Version](http://img.shields.io/npm/v/iobroker.megad.svg)
![Downloads](https://img.shields.io/npm/dm/iobroker.megad.svg)
![Tests](https://travis-ci.org/ioBroker/ioBroker.megad.svg?branch=master)
![NPM](https://nodei.co/npm/iobroker.megad.png?downloads=true)

Lässt die [MegaD-328](http://www.ab-log.ru/smart-house/ethernet/megad-328) über Ethernet steuern.
...
### Information
Das Gerät verfügt über 14 Ports, 0-7 Eingänge und 8-13 Ausgänge.
