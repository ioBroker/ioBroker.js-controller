...
** Hinweis: ** Wenn Sie im Auswahl-ID-Dialogfeld des ioBroker-Knotens keine Variablen finden, starten Sie die knotenrote Instanz neu. Durch einen Neustart wird die neue Liste der Objekte erstellt.
