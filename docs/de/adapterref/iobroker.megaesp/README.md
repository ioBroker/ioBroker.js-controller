...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.megaesp/README.md
title: kein Titel
hash: rrEFJwkYerquTCblm5SJhcy1XC38din97wXnJcyH6f4=
---
![Logo](../../../en/adapterref/iobroker.megaesp/admin/megad.png) ioBroker Mega-ESP-Adapter ===================

![NPM-Version](http://img.shields.io/npm/v/iobroker.megaesp.svg)
![Downloads](https://img.shields.io/npm/dm/iobroker.megaesp.svg)
![NPM](https://nodei.co/npm/iobroker.megaesp.png?downloads=true)

Lässt die [Mega-ESP](http://ab-log.ru/forum/viewtopic.php?f=1&t=1130) über Ethernet steuern.
...
### Information
Das Gerät verfügt über 10 Ports, Ein- / Ausgänge.
...
ioBrokerValue = MegaESPValue * Faktor + Offset;
...
MegaESPValue = (ioBrokerValue - Offset) / Faktor;
